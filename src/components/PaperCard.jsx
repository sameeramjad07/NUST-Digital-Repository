  ...
  return (
    <div className="p-6 border rounded-lg shadow-lg bg-white hover:shadow-xl transition-shadow duration-200">
      ...
      <div className='flex items-center justify-between mt-4'>
        ...
        <div>
          <Link to={`/publication/${encodeURIComponent(paper.title)}`} target='_blank' className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-bold rounded-lg text-lg px-4 py-2 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
            Visit Document
          </Link>
        </div>
      </div>
